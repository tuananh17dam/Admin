...
@slot('li_1') Hóa đơn @endslot
@slot('title') Danh sách hóa đơn @endslot
@endcomponent
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm">
                        <div class="mb-4">
                            <button type="button" class="btn btn-light waves-effect waves-light"><i class="bx bx-plus me-1"></i> Thêm hóa đơn</button>
                        </div>
                    </div>
