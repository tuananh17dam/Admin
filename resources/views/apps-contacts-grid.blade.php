          ...
          <div class="card text-center">
              <div class="card-body">
                  ...
                  <div class="mx-auto mb-4">
                      <img src="build/images/users/avatar-2.jpg" alt="" class="avatar-xl rounded-circle img-thumbnail">
                  </div>
      ...
      <div class="col-xl-3 col-sm-6">
          <div class="card text-center">
              <div class="card-body">
                  ...
                  <div class="mx-auto mb-4">
                      <img src="build/images/users/avatar-1.jpg" alt="" class="avatar-xl rounded-circle img-thumbnail">
                  </div>
      ...
      <div class="col-xl-3 col-sm-6">
          <div class="card text-center">
              <div class="card-body">
                  ...
                  <div class="mx-auto mb-4">
                      <img src="build/images/users/avatar-3.jpg" alt="" class="avatar-xl rounded-circle img-thumbnail">
                  </div>
      ...
      <div class="col-xl-3 col-sm-6">
          <div class="card text-center">
              <div class="card-body">
                  ...
                  <div class="mx-auto mb-4">
                      <img src="build/images/users/avatar-6.jpg" alt="" class="avatar-xl rounded-circle img-thumbnail">
                  </div>
      ...
      <div class="col-xl-3 col-sm-6">
          <div class="card text-center">
              <div class="card-body">
                  ...
                  <div class="mx-auto mb-4">
                      <img src="build/images/users/avatar-8.jpg" alt="" class="avatar-xl rounded-circle img-thumbnail">
                  </div>
      ...
      <div class="col-xl-3 col-sm-6">
          <div class="card text-center">
              <div class="card-body">
                  ...
                  <div class="mx-auto mb-4">
                      <img src="build/images/users/avatar-9.jpg" alt="" class="avatar-xl rounded-circle img-thumbnail">
                  </div>
